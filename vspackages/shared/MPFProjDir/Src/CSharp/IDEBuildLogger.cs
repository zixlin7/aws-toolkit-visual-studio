    ...
    internal class IDEBuildLogger : Logger
    {
        ...
        protected void QueueTaskEvent(BuildEventArgs errorEvent)
        {
            this.taskQueue.Enqueue(() =>
            {
                ...
                task.Navigate += new EventHandler((o, e) =>
                {
                    try
                    {
                        var errorListProvider = new ErrorListProvider(this.serviceProvider);
                        ...
                        errorListProvider.Navigate(copyTask, Guid.Parse(EnvDTE.Constants.vsViewKindCode));
                    }
                    catch { }
                });
