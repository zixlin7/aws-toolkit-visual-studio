...
namespace Microsoft.VisualStudio.Project
{
	...
	[ComVisible(true)]
	[CLSCompliant(false)]
	public abstract class ProjectAsyncPackage : Microsoft.VisualStudio.Shell.AsyncPackage
	{
		#region fields
		/// <summary>
		...
		#region methods
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<Shell.ServiceProgressData> progress)
		{
			await base.InitializeAsync(cancellationToken, progress);

            // Subscribe to the solution events
            var package = this as Microsoft.VisualStudio.Shell.Package;
            this.solutionListeners.Add(new SolutionListenerForProjectReferenceUpdate(package));
            this.solutionListeners.Add(new SolutionListenerForProjectOpen(package));
            this.solutionListeners.Add(new SolutionListenerForBuildDependencyUpdate(package));
            this.solutionListeners.Add(new SolutionListenerForProjectEvents(package));
