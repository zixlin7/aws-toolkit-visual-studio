...
namespace Amazon.AWSToolkit
{
    public class ToolkitFactory
    {
        ...
        readonly IShellProvider _shellProvider;
        ...
        private ToolkitFactory(NavigatorControl navigator, IShellProvider shellProvider)
        {
        ...
        public static void InitializeToolkit(NavigatorControl navigator, IShellProvider shellProvider, string additionalPluginPaths)
        {
            if (INSTANCE != null)
        ...
        public void RunFirstTimeSetup()
        {
            ...
            if (FirstRunSetupController.ShowOnStartup)
            {
                try
                {
                ...
                {
                    LOGGER.ErrorFormat("Caught exception launching first-run dialog, {0}, stack {1}", e.Message, e.StackTrace);
                }
            }
        }
