...
namespace Amazon.AWSToolkit.CommonUI
{
    ...
    {
        public static Window CreateDialogHost(MessageBoxButton buttons, IAWSControl hostedControl)
        {
            Window window = null;
            switch (buttons)
            {
        ...
        public static Window CreateFramelessDialogHost(IAWSControl hostedControl)
        {
            Window window = null;
