...
{
    /// <summary>
    /// Test class that surfaces portions of PublishToAwsCommandSolutionExplorer for testing
    /// </summary>
    public class TestPublishToAwsCommandSolutionExplorer : PublishToAwsCommandSolutionExplorer
    {
        public TestPublishToAwsCommandSolutionExplorer(
    ...
    public class PublishToAwsCommandSolutionExplorerTests
    {
        ...
        public PublishToAwsCommandSolutionExplorerTests()
        {
            ...
            _sut = new TestPublishToAwsCommandSolutionExplorer(null, _toolkitShell.Object, _publishSettingsRepository,
        ...
        public void BeforeQueryStatus_SolutionExplorerSelectsProject(SetupState setupState)
        {
            ...
            {
                Assert.Equal("Publish to AWS (Preview feature)...", _menuCommand.Text);
            }
        }
