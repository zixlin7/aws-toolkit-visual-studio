...
{
    /// <summary>
    /// PostMetrics Request Marshaller
    /// </summary>       
    public class PostMetricsRequestMarshaller : IMarshaller<IRequest, PostMetricsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PostMetricsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PostMetricsRequest publicRequest)
        {
        ...
        private static PostMetricsRequestMarshaller _instance = new PostMetricsRequestMarshaller();        

        internal static PostMetricsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostMetricsRequestMarshaller Instance
        {
            get
            {
                return _instance;
