...
namespace Amazon.AWSToolkit.CommonUI.Private
{
    /// <summary>
    /// This code was found from this stackoverflow article.
    /// http://stackoverflow.com/questions/616718/how-do-i-get-common-file-type-icons-in-c
    /// </summary>
    public class __IconHelper
    {
        ...
        public static Icon IconFromExtension(string extension, SystemIconSize size)
        {
            ...
            try
            {
                if(ApplicationKey.OpenSubKey("CurVer") != null)
