...
using OrderBy = Amazon.AWSToolkit.CloudWatch.Logs.Models.OrderBy;
...
namespace Amazon.AWSToolkit.CloudWatch.Logs.Core
{
    public class CloudWatchLogsRepository : ICloudWatchLogsRepository
    {
        ...
        public async Task<PaginatedLogResponse<LogEvent>> GetLogEventsAsync(Logs.Models.GetLogEventsRequest logEventsRequest,
            CancellationToken cancelToken)
        {
        ...
        public async Task<PaginatedLogResponse<LogEvent>> FilterLogEventsAsync(Logs.Models.FilterLogEventsRequest logEventsRequest,
            CancellationToken cancelToken)
        {
            VerifyLogGroupIsValid(logEventsRequest.LogGroup);
            VerifyLogStreamIsValid(logEventsRequest.LogStream);
        ...
        private GetLogEventsRequest CreateGetLogEventsRequest(Logs.Models.GetLogEventsRequest logEventsRequest)
        {
        ...
        private FilterLogEventsRequest CreateFilterLogEventsRequest(Logs.Models.FilterLogEventsRequest logEventsRequest)
        {
