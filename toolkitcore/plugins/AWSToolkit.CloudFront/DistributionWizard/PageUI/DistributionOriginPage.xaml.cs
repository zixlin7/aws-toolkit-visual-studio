...
{
    /// <summary>
    /// Interaction logic for DistributionOriginPage.xaml
    /// </summary>
    public partial class DistributionOriginPage
    {
        public DistributionOriginPage()
        {
            InitializeComponent();
        }

        public DistributionOriginPage(IAWSWizardPageController controller)
            : this()
        {
