...
namespace Amazon.AWSToolkit.EC2.Nodes
{
    public class VPCRootViewModel : EC2ServiceViewModel
    {
        ...
        public VPCRootViewModel(AccountViewModel accountViewModel, ToolkitRegion region)
            : base(accountViewModel.MetaNode.FindChild <VPCRootViewMetaNode>(), accountViewModel, "Amazon VPC", region)
        {
