...
{
    /// <summary>
    /// Interaction logic for SelectRepositoryControl.xaml
    /// </summary>
    public partial class SelectRepositoryControl
    {
        public SelectRepositoryControl()
        {
            InitializeComponent();
        }

        public SelectRepositoryControl(SelectRepositoryController controller)
            : this()
        {
        ...
        public SelectRepositoryController Controller { get; }
